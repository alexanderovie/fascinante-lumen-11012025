  ...
  return (
    <div className="section-padding container">
      <div className="mx-auto max-w-4xl">
        ...
        {/* Article Content */}
        <article className="prose prose-h2:text-3xl prose-h2:leading-tight lg:prose-lg lg:prose-h2:text-5xl prose-headings:font-weight-display dark:prose-invert prose-headings:tracking-tight prose-p:leading-relaxed prose-li:leading-relaxed prose-img:rounded-xl prose-img:shadow-sm prose-a:text-primary prose-a:no-underline hover:prose-a:underline mx-auto max-w-none">
          {content}
        </article>
      </div>
